...
<head>
    ...
    <style>
        ...
        .bg-main-soft {
            background-color: #D7E5B0 !important;
        }
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">pelayanan terintegrasi</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a id="liDashboard" class="nav-link " href="{{ URL::to('/dashboard') }}">
                        <div
                ...
                <li class="nav-item">
                    <a id="liProfile" class="nav-link  " href="{{ URL::to('/profile') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                @if (auth()->user()->role == 'Administrator')
                    ...
                    <li class="nav-item">
                        <a id="liWilayah" class="nav-link  " href="{{ URL::to('/wilayah') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <li class="nav-item">
                        <a id="liTanaman" class="nav-link  " href="{{ URL::to('/tanaman') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <span class="nav-link-text ms-1">Tanaman</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a id="liKmeans" class="nav-link  " href="{{ URL::to('/kmeans') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item">
                        <a id="liPemetaan" class="nav-link  " href="{{ URL::to('/pemetaan') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                @if (auth()->user()->role == 'user')
                    <li class="nav-item">
                        <a id="liAlternatif" class="nav-link  " href="{{ URL::to('/alternatives') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <span class="nav-link-text ms-1">Alternative</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a id="liAlternatifPilihan" class="nav-link  " href="{{ URL::to('/alternative-pilihan') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>Alternative Pilihan</title>
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(-1870.000000, -591.000000)" fill="#FFFFFF"
                                            fill-rule="nonzero">
                                            <g transform="translate(1716.000000, 291.000000)">
                            ...
                            <span class="nav-link-text ms-1">Alternative Pilihan</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a id="liHitung" class="nav-link  " href="{{ URL::to('/calculate') }}">
                            <div
                                class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <title>Hitung Vikor</title>
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(-1870.000000, -591.000000)" fill="#FFFFFF"
                                            fill-rule="nonzero">
                                            <g transform="translate(1716.000000, 291.000000)">
                            ...
                            <span class="nav-link-text ms-1">Hitung Vikor</span>
                        </a>
                    </li>
                @endif
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">pelayanan terintegrasi</h6>
                </nav>
                <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <div class="user">
                                <img src="{{ asset('template/mico-html/images/team2.jpg') }}" alt=""
                                    class="avatar avatar-sm me-3">
                                {{-- <span class="">{{ Auth::user()->name }} (
                                    {{ Auth::user()->role }}
                                    ) | </span> --}}
                            </div>
                            <a href="{{ URL::to('/logout') }}" class="nav-link text-body font-weight-bold px-0">
        ...
        <!-- End Navbar -->
        <div class="container-fluid py-4 my-main-content">
            {{-- content here --}}
        ...
        <div class="card shadow-lg ">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Pengaturan Aplikasi</h5>
                    <p>Custom tampilan aplikasi.</p>
                </div>
                ...
                <a href="javascript:void(0)" class="switch-trigger background-color">
                    <div class="badge-colors my-2 text-start">
                        ...
                        <span class="badge filter bg-gradient-info " data-color="info"
                            onclick="sidebarColor(this)"></span>
                        <span style="background-color: #4E6EF1 !important;"
                            class="badge filter bg-main the-main-color" data-color="dark"
                            onclick="sidebarColor(this)"></span>
