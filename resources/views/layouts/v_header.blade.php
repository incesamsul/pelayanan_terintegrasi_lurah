    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                @if (auth()->user()->role == 'Administrator')
                    ...
                    <li class="nav-item">
                        <a id="liSkIzinMenikah" class="nav-link  " href="{{ URL::to('/sk/sk-izin-menikah') }}">
                            ...
                            <span class="nav-link-text ms-1">SK Izin Menikah</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a id="liSktm" class="nav-link  " href="{{ URL::to('/sk/sktm') }}">
                            ...
                            <span class="nav-link-text ms-1">SKTM</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a id="liSkDomisili" class="nav-link  " href="{{ URL::to('/sk/sk-domisili') }}">
                            ...
                            <span class="nav-link-text ms-1">SK Domisili</span>
                        </a>
                    </li>
                ...
                {{-- <li class="nav-item">
                    <a id="LiSuratPengantar" class="nav-link  " href="{{ URL::to('/surat-pengantar') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
